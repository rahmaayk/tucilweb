    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="https://i.pinimg.com/236x/d8/79/f5/d879f50c907ce0c105c274f87ed9dcc5.jpg" class="img-circle" width="80"></a></p>
          <h5 class="centered">Rahmaa YK</h5>
          <li class="mt">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        ...
        image: 'https://i.pinimg.com/236x/d8/79/f5/d879f50c907ce0c105c274f87ed9dcc5.jpg',
